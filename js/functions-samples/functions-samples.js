var FunctionSamples = (function () {
  ...
  self.init = function () {
    functionLiteral();
    methodInvocationPattern();
    functionInvocationPattern();
    constructorInvocationPattern();
    applyInvocationPattern();
    argumentsSample();
    exceptionsSample();
    augmentingTypesSample();
    recursionSample();
    scopeSample();
    closureSample();
    callbacksSample();
  ...
  function methodInvocationPattern() {
    var fileAndLineIdentifier = new Error();
  ...
  function functionInvocationPattern() {
    var fileAndLineIdentifier = new Error();
    BaseModule.Printer.printSectionTitle('Function Invocation Pattern', fileAndLineIdentifier);
  ...
  function constructorInvocationPattern() {
    var fileAndLineIdentifier = new Error();
  ...
  function applyInvocationPattern() {
    var fileAndLineIdentifier = new Error();
  ...
  function augmentingTypesSample() {
    var fileAndLineIdentifier = new Error();
