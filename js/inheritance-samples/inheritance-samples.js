var InheritanceSamples = (function() {
  ...
  function createMammalObject() {
    ...
    BaseModule.Printer.printLine('"Cat" pseudoclass "purr" method exists: typeof myCat.purr = ' + typeof myCat.purr);
    BaseModule.Printer.printLine('"Mammal" does not have "purr" method: typeof myMammal.purr = ' + typeof myMammal.purr);
    ...
    BaseModule.Printer.printLine('"Dog" pseudoclass "run" method exists: typeof myDog.run = ' + typeof myDog.run);
    BaseModule.Printer.printLine('"Mammal" does not have "run" method: typeof myMammal.run = ' + typeof myMammal.run);
    BaseModule.Printer.printLine(
