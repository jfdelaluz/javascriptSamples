var ReferenceSample = (function() {
  ...
  function variablesWithSeparateObjectDefinitions() {
    var a = {}, b = {}, c = {};
    a.value = 'blablabla';
    BaseModule.Printer.printSectionTitle('Variables With Separate Object Definitions');
  ...
  function variablesToSameObjectDefinition() {
    var x = y = z = {};
    x.value = 'blebleble';
    BaseModule.Printer.printSectionTitle('Variables To Same Object Definition');
